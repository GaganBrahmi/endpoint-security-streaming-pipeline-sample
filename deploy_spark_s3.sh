...
echo "============================================================"
echo "  Deploy: MSK + Lambda + Spark Streaming (Standard S3)"
echo "============================================================"
echo ""
...
# ── Step 3: Spark Streaming (Standard S3) ──
echo "━━━ Step 3/3: Spark Streaming (Standard S3) ━━━"
cd "$SCRIPT_DIR/spark-streaming-s3"
./scripts/deploy.sh
echo ""

echo "============================================================"
echo "  ✅ Full Stack Deployed: MSK + Lambda + Spark (Standard S3)"
echo "============================================================"
echo ""
echo "Database:       endpoint_security_spark_s3"
echo "Generate data:  ./common/scripts/generate_data.sh"
echo "Submit job:     cd spark-streaming-s3 && ./scripts/submit_job.sh"
echo "Cleanup:        ./cleanup_spark_s3.sh"
echo ""
